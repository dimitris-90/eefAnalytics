...
```condopt```     |     additional arguments of [`stan_lmer`](https://mc-stan.org/rstanarm/reference/stan_glmer.html) to be passed only to the conditional model specification (for example, defining priors only for the conditional model, etc.).
```uncopt```     |     additional arguments of [`stan_lmer`](https://mc-stan.org/rstanarm/reference/stan_glmer.html) to be passed only to the unconditional model specification (for example, defining priors only for the unconditional model, etc.).
...
```...```     |     additional arguments of [`stan_lmer`](https://mc-stan.org/rstanarm/reference/stan_glmer.html) to be passed both to the conditional and unconditional model specifications.
